    ...
    return (
        <div className="container-fluid py-4" data-cy="agendar-consulta-page">
            ...
            <div className="d-flex justify-content-between align-items-center mb-4">
                ...
                <Link href="/dashboard/profissional/consultas" className="btn btn-outline-secondary" data-cy="btn-voltar">
                ...
                <div className="col-lg-4">
                    ...
                    <div className="card shadow mb-4" data-cy="info-paciente-card">
                        ...
                        <div className="card-body">
                            ...
                            <p data-cy="paciente-tipo"><strong>Tipo:</strong> Profissional</p>
                        </div>
                    </div>
